...
const stageReelAssets = [
  ...
  [40, 42, 43, 44, 45].map((asset) => `/slot/10%20Lakhs/Asset%20${asset}.svg`),
  [46, 48, 49, 50, 51, 52].map((asset) => `/slot/240%2B/Asset%20${asset}.svg`),
  [53, 54, 56, 57, 58].map((asset) => `/slot/8K%2B/Asset%20${asset}.svg`),
  [
...
const stageFinalAssets = [
  ...
  [
    "/slot/240%2B/Asset%2052.svg",
    "/slot/240%2B/Asset%2051.svg",
    "/slot/240%2B/Asset%2050.svg",
    "/slot/240%2B/Asset%2049.svg",
  ],
  [
    "/slot/8K%2B/Asset%2053.svg",
    "/slot/8K%2B/Asset%2058.svg",
    "/slot/8K%2B/Asset%2057.svg",
    "/slot/8K%2B/Asset%2056.svg",
  ],
  [
    "/slot/Infinity/Asset%2082.svg",
    "/slot/Infinity/Asset%2080.svg",
